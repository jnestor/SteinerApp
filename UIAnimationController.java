 ...
 * @Date: 2020-06-24T21:04:56-04:00
 * @Email: nestorj@lafayette.edu
 * @Last modified by: nestorj
 * @Last modified time: 2020-06-24T21:04:56-04:00
 */
 ...
 * -style control panel (stop/start/pause/step). Starts and runs the animated
 * algorithm a separate thread. Algorithm is called using the runAnimation
 * method of the UIAnimated interface. The algorithm then calls back to its user
 * interface at interesting events and the UI calls animateDelay() to wait for
 * the next update. PAUSE and STEP commands are realized by waiting in
 * animateDelay(). STOP is realized by killing the thread containing the
 * animation.
 *
 * Copyright: Copyright (c) 2006 Company: Lafayette College
 *
 * @author John Nestor
 * @version 1.0
 *
